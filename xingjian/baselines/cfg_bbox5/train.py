...
if __name__ == "__main__":
    ...
    if FLAGS.dataset == 'CLEVR_1O':

        dataset = AdaptedDataset()
        dataloader = DataLoader(dataset, batch_size=FLAGS.batch_size, shuffle=True, num_workers=FLAGS.data_workers, collate_fn=collate_adapted)
        model = Denoise(4, 4)
