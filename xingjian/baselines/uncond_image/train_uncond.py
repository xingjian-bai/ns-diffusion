...
def parse_args():
    parser = argparse.ArgumentParser(description="training unconditional diffusion model")
    parser.add_argument(
        "--name",
        type=str,
        default="default",
    ...
    parser.add_argument(
        ...
        type = str,
        default = "data",
        help="control parameter to the self-designed dataset"
    )
    # parser.add_argument(
    #     "--dataset_name",
    #     type=str,
...
def main(args):
    ...
    if args.data == "2O":
        ...
        dataset = RelationalDataset2O(uncond_image_type = args.uncond_image_type)
    else:
    ...
    for epoch in range(first_epoch, args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            ############################### redesign the dataformat
            clean_images = batch["clean_image"].to(accelerator.device)
